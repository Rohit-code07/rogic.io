...
resource "aws_cognito_user_pool" "user_pool" {
  name                     = "nemologic-production-user-pool-${random_string.suffix.result}"
  ...
  tags = {
    Name = "nemologic-production-user-pool"
  }
}
...
resource "aws_cognito_user_pool_client" "client" {
  name                                 = "nemologic-production-client-${random_string.suffix.result}"
  user_pool_id                         = aws_cognito_user_pool.user_pool.id
...
resource "aws_cognito_user_pool_domain" "domain" {
  domain       = "nemologic-prod-auth-${random_string.suffix.result}"
  user_pool_id = aws_cognito_user_pool.user_pool.id
}
